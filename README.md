...
[![CI](https://github.com/hydrz/go-example/actions/workflows/ci.yml/badge.svg)](https://github.com/hydrz/go-example/actions/workflows/ci.yml)
...
```bash
go get github.com/hydrz/go-example
```
...
## CHANGELOG
See [Releases](https://github.com/hydrz/go-example/releases)
